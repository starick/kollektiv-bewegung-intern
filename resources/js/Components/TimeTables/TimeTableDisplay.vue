  ...
  <div class="flex flex-col items-center justify-center min-h-screen m-6">
    ...
    >
      ...
      <div class="absolute bottom-2 left-2 text-sm opacity-70">
        <p>
          Sofern nicht anders angegeben, finden die Kurse im Bewegungsraum der B-Side (Am
          Mittelhafen 42) statt.
        </p>
    ...
    <PrimaryButton class="mt-6" @click="download">Download</PrimaryButton>
  </div>
</template>
