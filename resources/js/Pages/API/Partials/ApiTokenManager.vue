      ...
      <template #form>
        ...
        <div v-if="availablePermissions.length > 0" class="col-span-6">
          ...
          <div class="mt-2 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div v-for="permission in availablePermissions" :key="permission as PropertyKey">
